...
<html lang="en">
    ...
    <body>
        ...
        <section id="wrapper" class="login-register" style="background:url(<?php echo base_url(); ?>main_assets/admin_asset/assets//plugins/images/login-register.jpg)center center/cover no-repeat!important;">
            <div class="login-box login-sidebar">
                <div class="white-box">
                    <form class="form-horizontal form-material" id="loginform" action="<?php echo base_url(); ?>auth/login" method="post">
                        <a href="javascript:void(0)" class="text-center db"><img src="<?php echo base_url(); ?>main_assets/admin_asset/assets/plugins/images/eliteadmin-logo-dark.png" alt="Home" />
                            <br/>
                            <img src="<?php echo base_url(); ?>main_assets/admin_asset/assets/plugins/images/eliteadmin-text-dark.png" alt="Home" /></a>
                        <?php echo $this->session->flashdata('flash_message'); ?>
                        <div class="form-group m-t-40">
                            <div class="col-xs-12">
                                <input class="form-control" name="username" type="text" required="" placeholder="Inputkan Username">
                            </div>
                        </div>

...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Halaman Tambah Produk</h4>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="white-box col-md-12">
                <form class="form" data-toggle="validator" action="<?php echo site_url('produk/post_produk'); ?>" enctype="multipart/form-data" method="post">
                    <h3 class="box-title m-b-0">Formulir Tambah Produk</h3>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-8">
                                                <div class="form-group" > 
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="token" value="<?php echo $random; ?>" style="display:none" />
                                                        <input type="text" name="nama_produk" class="form-control" id="namaproduk" placeholder="Inputkan Nama Produk" required>
                                                    </div>                           
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group" > 
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="sku_produk" class="form-control" id="skuproduk" placeholder="Inputkan SKU" required>
                                                    </div>                           
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">          
                                                    ...
                                                    <div class="input-group">
                                                        <input type="checkbox" class="rekomen" name="status_rekomendasi" data-on-text="YA" data-off-text="TIDAK" data-on-color="success" data-off-color="default">
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">          
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="bahan_produk" class="form-control" id="bahanproduk" placeholder="Inputkan Bahan Produk" required>
                                                    </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="1" name="minimal_pembelian" class="form-control" id="minbeli" placeholder="Min. Pembelian" required>
                                                    </div>
                                                    <small class="form-text"><b class="text-danger">*WAJIB </b>diisi</small> 
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="1" name="stok_barang" class="form-control" id="stokbarang" placeholder="Stok Barang" required>
                                                    </div>
                                                    <small class="form-text"><b class="text-danger">*WAJIB </b>diisi</small> 
                                                </div>
                                            </div>        
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="asalproduk" name="asal_produk" required>
                                                        <option value="" disabled selected>Asal Produk</option>
                                        ...
                                        <div class="col-md-12">                      
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="voucher" name="voucher" required>                               
                                                        <option value="0" selected>Tidak Ada (*tanpa voucher)</option>
                                                        <?php
                                                        if (!empty($voucher)) {
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="tag_barang" data-role="tagsinput" placeholder="Inputkan Tag" />                          
                                ...
                                <div id="collapseTwo"  class="panel-collapse expand" role="tabpanel" aria-labelledby="headingTwo">
                                    <div class="panel-body">
                                        <div class="col-md-12">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" name="harga_barang" type="text" id="hargabarang" placeholder="Inputkan Harga" data-mask="000.000.000.000.000" data-mask-reverse="true" required>                               
                                                    </div>
                                                    <small class="form-text"><b class="text-danger">*WAJIB </b>diisi</small> 
                                                </div>
                                            </div>   
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="pot_harga" class="control-label">Potongan Promo *</label>
                                                    <div class="help-block with-errors"></div>
                                                    <div class="input-group">                                
                                                        <input type="number" min="1" max="100" name="potongan_harga" class="form-control" id="pot_harga" placeholder="Persentase" required>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">Rp.</span>
                                                        <input class="form-control" name="harga_promo" type="text" placeholder="0.00" data-mask="000.000.000.000.000" data-mask-reverse="true" >                               
                                                    </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">          
                                                    ...
                                                    <div class="input-group">
                                                        <input type="checkbox" class="sensor" name="status_sensor_harga" value="0" data-on-text="YA" data-off-text="TIDAK" data-on-color="success" data-off-color="default">
                                                    </div>
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    ...
                                                    <div class="help-block with-errors"></div>
                                                    <div class="input-group">                                   
                                                        <input type="number" min="1" name="start_digit" class="form-control" id="startdigit" placeholder="" required>
                                                    </div>
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    ...
                                                    <div class="help-block with-errors"></div>
                                                    <div class="input-group">                                   
                                                        <input type="number" min="1" name="end_digit" class="form-control" id="enddigit" placeholder="" required>
                                                    </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <textarea class="form-control" id="spesifikasiproduk" rows="10" name="spesifikasi_barang"></textarea>
                                                </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-12">
                                            <div class="form-group"> 
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="link_shopee" placeholder="Inputkan Link Shopee" >
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group"> 
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="ti-link"></i></div>
                                                    <input type="text" class="form-control" name="link_tokopedia" placeholder="Inputkan Link Tokopedia" >
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group"> 
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="ti-link"></i></div>
                                                    <input type="text" class="form-control" name="link_lazada" placeholder="Inputkan Link Lazada" >
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group"> 
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="ti-link"></i></div>
                                                    <input type="text" class="form-control" name="link_bukalapak" placeholder="Inputkan Link Bukalapak" >
                                                </div>
...
<!--<script>
    $("#namaproduk").on('input', function () {
        ...
        var id_sku = acronym + "-" + $('#kategoribarang').val();
        ...
        removedfile: function (file) {
            swal({
                ...
                if (isConfirm) {
                    ...
                    swal("Dibatalkan", "Gambar gagal terhapus", "error");
                }
            });
        }
    });

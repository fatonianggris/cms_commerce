...
class Mailmodel extends CI_Model {
    ...
    public function get_jumlah() {
        $sql = $this->db->query('select (select count(id_newsletter) from newsletter_customer) as total_newsletter, (select count(id_pelanggan) from pelanggan) as total_pelanggan');
        return $sql->result();
    }
    ...
    public function get_by_id_mail($id = '') {
